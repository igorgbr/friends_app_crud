defmodule FriendsApp.DB.CSV do
  ...
  defp update do
    ...
    prompt_message("Enter the name of the friend to update: ")
  ...
  defp confirm_update(friend) do
    Shell.cmd("clear")
    Shell.info("Confirma a exclusão do amigo?")
